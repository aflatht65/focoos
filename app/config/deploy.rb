set :application, "socialcouriers"
set :user,        "socialcouriers"
set :domain,      "socialcouriers.dnna.gr"
set :deploy_to,   "/home/socialcouriers/capifony"
set :app_path,    "app"

set :repository,  "git@github.com:dnna/socialcouriers.git"
set :scm,         :git
